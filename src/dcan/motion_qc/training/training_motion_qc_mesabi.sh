...
export PYTHONPATH=PYTHONPATH:"/home/faird/shared/projects/motion-QC-generalization/code/AlexNet_Abrol2021/src"
/home/umii/hendr522/SW/miniconda3/envs/AlexNet_Arbol2021/bin/python \
  /home/faird/shared/projects/motion-QC-generalization/code/AlexNet_Abrol2021/src/dcan/motion_qc/training/training.py --num-workers=4 --batch-size=8 \
  ...
  --model-save-location="/home/feczk001/shared/data/AlexNet/motion-qc-model04_TJH_test.pt" \
