...
#SBATCH --job-name=elabe-motion-training-alex-net # job name
...
#SBATCH -e elabe-motion-alex-net-training-%j.err
#SBATCH -o elabe-motion-alex-net-training-%j.out
...
/home/miran045/reine097/projects/AlexNet_Abrol2021/venv/bin/python \
  ...
  --tb-prefix="MRIMotionQcScore_elabe" --epochs=256 --model="AlexNet3D_Dropout_Regression" \
  --dset="MRIMotionQcScoreDataset" \
  --model-save-location="/home/feczk001/shared/data/AlexNet/motion_qc_elabe_00.pt" \
  --csv-data-file="/panfs/jay/groups/6/faird/shared/projects/motion-QC-generalization/code/elabe_qc_train_space-infant_unique.csv"
